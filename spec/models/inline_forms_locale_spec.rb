...
#       GENERATED TESTS 			#
#####################################
#This is a test for InlineFormsLocale
require "spec_helper"
...
describe InlineFormsLocale do
  it "insert a data into InlineFormsLocale and retrieves it back" do
  	data = InlineFormsLocale.new
	...
	# For Belongs_to do nothing I think it need to happen automatic
		...
		expect(InlineFormsLocale.first).to eq(data)
	end
end	